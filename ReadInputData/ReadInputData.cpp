...
std::vector<StockOrder> ReadInputData::getDataFromFile()
{
    getFileName();
...
void ReadInputData::getFileName()
{
    std::string path = "./";
...
StockOrder ReadInputData::getStockOrder(std::string line)
{
    StockOrder order;
...
void ReadInputData::printOrder(const StockOrder& order)
{
    std::string side = static_cast<int>(order.side)?"Sell":"Buy";
